...
export default function Button({
  ...
  const variants = {
    primary: 'bg-primary text-white hover:bg-primary/95 shadow-card hover:translate-y-[-1px] active:translate-y-[0px]',
    secondary: 'bg-white border border-outline-variant text-on-surface hover:bg-surface hover:text-primary active:bg-outline-variant/10',
